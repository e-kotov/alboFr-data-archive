...
The data is fetched once a week with https://github.com/e-kotov/alboFr R package and new geojson is committed to this repo on top of the old file. A new version of geojson is also uploaded to the releases in this repo.
